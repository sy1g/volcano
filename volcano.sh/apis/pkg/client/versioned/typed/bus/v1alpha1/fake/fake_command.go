...
type fakeCommands struct {
	*gentype.FakeClientWithList[*v1alpha1.Command, *v1alpha1.CommandList]
	Fake *FakeBusV1alpha1
}

func newFakeCommands(fake *FakeBusV1alpha1, namespace string) busv1alpha1.CommandInterface {
	return &fakeCommands{
		gentype.NewFakeClientWithList[*v1alpha1.Command, *v1alpha1.CommandList](
			fake.Fake,
			namespace,
