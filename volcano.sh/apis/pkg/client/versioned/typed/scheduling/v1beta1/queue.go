...
type queues struct {
	*gentype.ClientWithList[*schedulingv1beta1.Queue, *schedulingv1beta1.QueueList]
}

// newQueues returns a Queues
func newQueues(c *SchedulingV1beta1Client) *queues {
	return &queues{
		gentype.NewClientWithList[*schedulingv1beta1.Queue, *schedulingv1beta1.QueueList](
			"queues",
			c.RESTClient(),
