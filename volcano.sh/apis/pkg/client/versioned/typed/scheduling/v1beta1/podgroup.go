...
type podGroups struct {
	*gentype.ClientWithList[*schedulingv1beta1.PodGroup, *schedulingv1beta1.PodGroupList]
}

// newPodGroups returns a PodGroups
func newPodGroups(c *SchedulingV1beta1Client, namespace string) *podGroups {
	return &podGroups{
		gentype.NewClientWithList[*schedulingv1beta1.PodGroup, *schedulingv1beta1.PodGroupList](
			"podgroups",
			c.RESTClient(),
