...
type fakePodGroups struct {
	*gentype.FakeClientWithList[*v1beta1.PodGroup, *v1beta1.PodGroupList]
	Fake *FakeSchedulingV1beta1
}

func newFakePodGroups(fake *FakeSchedulingV1beta1, namespace string) schedulingv1beta1.PodGroupInterface {
	return &fakePodGroups{
		gentype.NewFakeClientWithList[*v1beta1.PodGroup, *v1beta1.PodGroupList](
			fake.Fake,
			namespace,
